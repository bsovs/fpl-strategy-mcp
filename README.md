...
The installers download the latest release binary; each GitHub release also publishes SHA-256 checksums. To pin a version, set `FPL_STRATEGY_VERSION=0.1.0` before running the installer.
